...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  User find(i64 id)")
...
func main() {
	...
	client := users.NewUsersServiceClientFactory(trans, protocolFactory)
	...
	case "find":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "Find requires 1 args")
			flag.Usage()
		}
